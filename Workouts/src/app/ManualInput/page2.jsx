{
  /* OLD AXIOS CODE, SAVING IN CASE WE NEED TO SWITCH BACK, MOVING TO REALM(WHAT IS RECOMENDED IN MONGODB DOCS)  */
}
...

{
  /* TODO: 
    CHANGED TO TYPESCRIPT - FIX ALL THE RED - HOW IS IT SAYING THE MODULES DON'T EXIST IF WE ARE USING THEM?
      ...
      we actually weren't using them, we haven't tested in a while - they weren't even installed, nice, TS
