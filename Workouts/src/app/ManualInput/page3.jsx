{
  /* THIS IS AN OLD WAY TO SAVE OUR EXERCISES IN 'exercise.json' APPEND METHOD
WE ARE HOSTING THIS ON VERCEL SO WE CAN USE IT ANYWHERE, VERCEL IS SERVERLESS,
WILL NOT ALLOW US TO WRITE/UPDATE JSON FILES ON THE PLATFORM
SAVING FOR THE UNLIKELY FUTURE APPLE ALLOWS SIDELOADING IN THEIR WALLED GARDEN 
SO WE CAN RUN OUR APP LOCALLY WITHOUT INTERNET AT DA GYM*/
}
